...
export const EVALUATION_ITEMS: EvaluationItemDefinition[] = [
  ...
  },
  {
    ...
    labelJa: "クロージング",
    description:
      "提案した企業について、その面談の中で「応募する/しない」という明確な意思とその理由まで引き出せたかどうかで評価すること。" +
      "次回面談の日程を確保できたというだけでは高評価にしないこと。企業への意思決定を得られないまま次回に持ち越した場合は、" +
      "たとえ次回のアポイントが取れていても、意思決定を先送りしただけとみなし、高い点数(4〜5点)は付けないこと。" +
      "目安: 5点=すべての提案企業についてYes/Noと理由まで明確に確認できた/4点=大半の企業について確認できた/" +
      "3点=一部の企業についてのみ確認できた/2点=ほとんど意思確認できず次回に持ち越した/1点=意思確認を全く行わないまま終えた。",
    displayOrder: 12,
    showInListSummary: true,
  },
];
